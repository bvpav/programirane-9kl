...
Ситуация, при която резултатът от аритметична операция е непредставим в интервала и се избубват битове.

## Какъв е броя на битовете, необходими за записване на резултата при аритметична операция?

Ако параметрите имат n бита, то спри събиране и изваждане са необходими n+1 бита, при умножение – 2n, а при деление – n.
