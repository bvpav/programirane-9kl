...
Значението, което даваме на битовте.
...
Универсалният компютър може да симулира вс друго устройство, а личния калкулаторът може да изпълнява само конкретни фиксирани операции.

## Какво е soft в software?

Универсалността се състои от "меко" контролиране на реда на примитивните опреации, задаван с програма.

## От какво се състои програма?

Програмата се състои от последователност от кодове на инструкции, вс от които извършва проста операция (местене, събиране и др.) или преход до др точка от програмата.
...
Процесора има съвесем малко памет, състояща се от няколко клетки, наречени регистри.
...
Върху данни в регистрите, или клетки от рамта.
...
Чрез рамта и външния свят комуникира с него чрез рамта.
...
Свързва вс компоненти на компютъра и осигурява захранването помежду им.
...
Реда на директориите, които съдържат файла, започвайли от корена.
...
Зареждащ модул, ядро, драйвери, библиотреки и инструменти за администрация и разработка.
...
Потребителски интерфейс на съвкупност от телстов редактов, компилатор, дебъгер, сорс контрол система.
...
Вс процес работи във собствена "виртуална" памет.
...
Изпрания елемент от графичния потреибителски интерфейс, който получава съобщенията от клавиатурата.
...
Метод за общуване с компютър, при който се пишат команди с параметри от клавиатурата и след натискане на ентер, се изпълнява командата и изважда редова информация към принтер или монитор в текстов режим.
