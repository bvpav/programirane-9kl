...
Универсалният компютър може да симулира всяко друго устройство, а личният калкулатор може да изпълнява само конкретни фиксирани операции.
...
| ----------------- | ----------------------------------------------------------------------------------------------- |
| Зареждащият модул | зарежда ядрото в паметта при стартиране на ОС.                                                  |
...
Програма по време на нейното изпълнение.

### Как са изолирани процесите?

Всеки процес работи в собствена „виртуална“ памет.
