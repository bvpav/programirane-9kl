...
Параметрите на функция в декларацията й.

### Кои параметри са фактически?

Параметрите на функция при извикването й.
...
Започва от първата й декларация и завършва в края блока в който е дефинирана или в края на сорс файла.
