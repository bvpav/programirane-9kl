...
Точно опътване за решаване на проблем или вид проблеми.
...
## От какво се състои конектора?

2 кръгчета с = номер.

## Какво се съдържа в конектора?

номер .-.

## Как конектора променя алгоритъма?
...
## Колко края може да има един алгорътм?

Поне едно, до безкрай.
...
Имена на променливи, от които се връща резултат от работата на алго.
...
присвояване на променливи с =, или обръщение към др алго.
...
Условие за повторение, последвано от структора тяло.

## В какъв ред се изпълняват елементите на цикъл с префиксно-условие?

Пътво се проверява условието и в зависимост от него, се изпълнява тялото.
